...
export const MESSAGES = {
  ...
  asstNoteLabel: { zh: '发布后备注（保存到已发布记录）', en: 'Post-publish note (saved to the published record)' },
  asstNoteSave: { zh: '保存', en: 'Save' },
  asstNoteDefault: { zh: '有审核', en: 'Has moderation' },
  asstNoteSaved: { zh: '备注已保存到已发布记录', en: 'Note saved to the published record' },
